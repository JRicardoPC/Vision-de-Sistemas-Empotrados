...
private:
   ...
   const bool fullDP = true;
      ...
      cv::Ptr<cv::StereoSGBM> ssgbm = cv::StereoSGBM::create(minDisparity, ndisparity, blockSize, 
...
public:
   DisparitySGBM()   : it_(nh_),
      ...
      sync_(MySyncPolicy(100),image_left_sub_, cameraInfoL_, image_right_sub_, cameraInfoR_)
   {
      sync_.registerCallback(boost::bind(&DisparitySGBM::disparity_callback, this, _1, _2, _3, _4));
      ...
      disparity_sgbm_pub_ = nh_.advertise<stereo_msgs::DisparityImage>("/tfg/disparityImage/sgbm", 1);  
   }
